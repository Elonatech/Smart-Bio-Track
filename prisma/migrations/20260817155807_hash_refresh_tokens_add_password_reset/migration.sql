...
-- Refresh tokens are disposable session state, and the old plaintext values
-- cannot be converted into hashes. Clear the table so the NOT NULL column can
-- be added. Everyone signs in again once.
